...
export default function DestinationDetailPage() {
  ...
  if (notFound) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-24 text-center">
        ...
        <p className="mt-2 text-muted-foreground">We couldn't find that destination.</p>
        <Link to="/destinations" className="mt-6 inline-flex items-center gap-1.5 text-primary hover:underline">
  ...
  if (!destination) {
    return <div className="mx-auto max-w-7xl px-4 py-20 text-muted-foreground md:px-6">Loading destination…</div>;
  }
        ...
        <div className="grid gap-10 lg:grid-cols-3">
          <div className="lg:col-span-2">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              {destination.attractions.map((a) => (
                <div key={a.name} className="rounded-2xl border border-border/60 bg-card p-5 shadow-sm">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-24 rounded-2xl border border-border/60 bg-card p-6 shadow-sm">
              ...
              <Link
                to={`/planner?dest=${destination.slug}`}
              ...
              <Link
                to={`/calculator?dest=${destination.slug}`}
